...
import P3N_DEMON_DATA_JSON from './data/p3n-demon-data.json';
...
import P3N_SKILL_DATA_JSON from './data/p3n-skill-data.json';
...
import P3N_PARTY_DATA_JSON from './data/p3n-party-data.json';
...
function createCompConfig(): CompendiumConfigSet {
  ...
  for (const skillSet of [VAN_SKILL_DATA_JSON, FES_SKILL_DATA_JSON, P3N_SKILL_DATA_JSON, P3P_SKILL_DATA_JSON]) {
  ...
  for (const partyData of [FES_PARTY_DATA_JSON, P3N_PARTY_DATA_JSON, P3P_PARTY_DATA_JSON]) {
  ...
  const ALL_DEMONS = [
    VAN_DEMON_DATA_JSON, FES_DEMON_DATA_JSON, P3N_DEMON_DATA_JSON, ANS_DEMON_DATA_JSON, P3P_DEMON_DATA_JSON,
    FES_PARTY_DATA_JSON, P3N_PARTY_DATA_JSON, P3P_PARTY_DATA_JSON
  ]
  ...
  for (const game of ['p3', 'p3f', 'p3n', 'p3a', 'p3p']) {
    compConfigs[game] = {
      appTitle: 'Persona 3',
      appCssClasses: ['p3'],
  ...
  compConfigs.p3n.appTitle = 'Persona 3 Nightfall';
  compConfigs.p3n.demonData = [P3N_DEMON_DATA_JSON, P3N_PARTY_DATA_JSON];
  compConfigs.p3n.skillData = [VAN_SKILL_DATA_JSON, FES_SKILL_DATA_JSON, P3N_SKILL_DATA_JSON];
